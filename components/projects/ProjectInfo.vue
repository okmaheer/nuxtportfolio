...
// Define props with a default structure to ensure required fields are present
const props = defineProps({
  projectInfo: {
    ...
    default: () => ({
      ...
      technologies: [{ title: '', techs: [] }],  // Ensure technologies array has at least one object
...
<template>
  <div class="block sm:flex gap-0 sm:gap-10 mt-14">
    ...
    <div class="w-full sm:w-1/3 text-left">
      ...
      <div v-if="projectInfo.technologies && projectInfo.technologies.length > 0" class="mb-7">
        <p class="font-general-medium text-2xl text-ternary-dark dark:text-ternary-light mb-2">
      ...
      <div>
        ...
        <div class="flex items-center gap-3 mt-5">
          <a v-for="social in projectInfo.socialSharings" :key="social.id" :href="social.url" target="_blank"
