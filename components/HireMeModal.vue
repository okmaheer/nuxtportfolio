...
<template>
  <transition name="fade">
    <div v-show="props.modal" class="font-general-regular fixed inset-0 z-30">
      ...
      <main class="flex flex-col items-center justify-center h-full w-full">
        <transition name="fade-up-down">
          <div v-show="props.modal" class="modal-wrapper flex items-center z-30">
            <div
            ...
            >
              ...
              <div class="modal-footer mt-2 sm:mt-0 py-5 px-8 border-t text-right">
                <Button
                  title="Close"
