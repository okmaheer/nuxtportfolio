...
const categories = ref([
  ...
  { id: 4, value: 'branding', name: 'Branding & Animation' },
]);
...
const showModal = () => {
  ...
  document.documentElement.classList.toggle('overflow-y-hidden', modal.value);
};
    ...
    >
      ...
      <div class="hidden sm:flex justify-between items-center flex-col md:flex-row">
        ...
        <div class="hidden md:block">
          <!-- Placeholder for a button if needed in the future -->
        </div>
